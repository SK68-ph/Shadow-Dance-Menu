...
public:
    ...
    virtual void C_BasePlayer__CalcView(void*&eyeOrigin, void* &eyeAngles, float &zNear, float &zFar, float &fov);
    virtual void C_BasePlayer__CalcViewModelView(const void*& eyeOrigin, const void*& eyeAngles);
    virtual void C_BasePlayer__CalcRoll(const void*& angles, const void*& velocity, float rollangle, float rollspeed);
    ...
    virtual void** C_BasePlayer__GetFlashlightOffset(void); //realunderwater+30
    ...
    virtual void ViewPunch( const void*& out );
    ...
    virtual void* C_BasePlayer__GetPlayerMins(void);
    virtual void* C_BasePlayer__GetPlayerMaxs(void);
    ...
    virtual void* C_BasePlayer__GetPunchAngle(void);
    virtual bool sub_2AF93E0(); // added after ti8 - returns 1 by default.
    virtual float C_BasePlayer__GetMinFOV(void);
    virtual void C_BasePlayer__UpdateStepSound(void* CPhysSurfaceProperties, const void*&pos, const void*&unk);
    virtual void C_BasePlayer__PlayStepSound(void*&pos, void* CPhysSurfaceProperties, float unk, bool unk2);
    virtual void C_BasePlayer__GetFootstepSurface(const void*&pos, const char* unk); // RegisterStringToken0
    ...
    virtual void C_BasePlayer__CalcPlayerView(void*& eyeOrigin, void*& eyeAngles, float& fov);
    virtual int loc_2DCC4F0(); //diretide 2020 - returns 0
    virtual float sub_2C339B0(); //diretide 2020 - returns a float from inside.
    virtual void C_DOTAPlayer__CalcObserverView(void*& eyeOrigin, void*& eyeAngles, float& fov); //switch: 7 cases
    virtual void C_BasePlayer__GetChaseCamViewOffset(void *targetC_BaseEntity );
    virtual void C_BasePlayer__CalcChaseCamView(void*& eyeOrigin, void*& eyeAngles, float& fov);
    virtual void C_BasePlayer__CalcInEyeCamView(void*& eyeOrigin, void*& eyeAngles, float& fov);
    virtual void C_BasePlayer__CalcDeathCamView(void*& eyeOrigin, void*& eyeAngles, float& fov);
    virtual void C_BasePlayer__CalcRoamingView(void*& eyeOrigin, void*& eyeAngles, float& fov);
    virtual void C_BasePlayer__CalcFreezeCamView(void*& eyeOrigin, void*& eyeAngles, float& fov);
    virtual void C_BasePlayer__SetLocalViewAngles(const void* &viewAngles);
    virtual void C_BasePlayer__SetViewAngles(const void*& ang);
