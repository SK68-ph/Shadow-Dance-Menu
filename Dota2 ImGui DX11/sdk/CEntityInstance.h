...
public:
    ...
    virtual void* C_BaseModelEntity__GetCollideable(void); // moved w/ diretide 2020
    ...
    virtual void C_BaseFlex__SetupWeights(void* matrix, int unk, float* unk2, float* unk3);
    virtual void C_BaseEntity__GetVectors(void* outForward, void* outRight, void* outUp);
    virtual const void* C_BaseEntity__WorldAlignMins(void);
    virtual const void* C_BaseEntity__WorldAlignMaxs(void);
    virtual const void* C_BaseEntity__WorldSpaceCenter(void);
    ...
    virtual bool C_BaseEntity__InSameTeam(void* otherEnt); // double edi
    ...
    virtual int C_BaseEntity__GetUseType(void* ent);
    ...
    virtual void C_BaseEntity__EstimateAbsVelocity(void*& out);
    ...
    virtual void C_BaseEntity__DispatchTraceAttack(void* CTakeDamageInfo, void*& direction, void* CGameTrace);
    virtual void C_BaseEntity__TraceAttack(void* CTakeDamageInfo, void*& direction, void* CGameTrace);
    ...
    virtual void* C_DOTAPlayer__EyePosition(void);
    virtual void* C_DOTAPlayer__EyeAngles(void);
    virtual void* C_BasePlayer__LocalEyeAngles(void);
    virtual void* C_BasePlayer__EarPosition(void);
    virtual float C_BaseEntity__GetFriction(void);
    virtual void* C_BaseModelEntity__GetViewOffset(void);
    virtual float C_BaseEntity__GetSmoothedVelocity(void);
    virtual void C_BaseEntity__GetVelocity(void* out1, void* out2);
    virtual bool C_BaseEntity__IsMoving(void);
    virtual void C_BaseEntity__OnGroundChanged(void* C_BaseEntity, void* C_BaseEntity2);
    virtual void C_BasedEntity__GetGroundVelocityToApply(void*& out);
    ...
    virtual const void* C_BaseEntity__GetRenderOrigin(void);
    virtual const void*& C_BaseEntity__GetRenderAngles(void);
    virtual void C_BaseEntity__GetObserverCamOrigin(void);
    virtual void C_BaseEntity__RenderableToWorldTransform(void);
    virtual void C_BasePlayer__DrawModel(int flags, void*);
    virtual void C_BaseEntity__GetRenderBounds(void*& out1, void*& out2);
    virtual void C_BaseEntity__GetRenderBoundsWorldSpace(void*& out1, void*& out2);
    ...
    virtual void C_BaseAnimating__FormatViewModelAttachment(int unk, void*& matrix);
